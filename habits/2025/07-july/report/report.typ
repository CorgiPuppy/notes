...
#figure(
    table(
        ...
        cell([Date], rowspan: 3), cell([Sleep], colspan: 2), cell([Hygiene], colspan: 7), cell([Learning], rowspan: 3),
        ...
        /*
        cell([Дата], rowspan: 3), cell([Сон], colspan: 2), cell([Гигиена], colspan: 7),  cell([Обучение], rowspan: 3),
